...
/**
 * Pdif212p0Id generated by hbm2java
 */
@Embeddable
public class Pdif212p0Id implements java.io.Serializable {
...
/*	private String pdno;
	...
	public Pdif212p0Id(String pdno, String prdtTypeCd, String elsEvntDvsnCd, long elsEvntSeq) {
		this.pdno = pdno;
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof Pdif212p0Id))
			return false;
		Pdif212p0Id castOther = (Pdif212p0Id) other;
		...
		return ((this.getPdno() == castOther.getPdno()) || (this.getPdno() != null && castOther.getPdno() != null && this
				...
				&& ((this.getElsEvntDvsnCd() == castOther.getElsEvntDvsnCd()) || (this.getElsEvntDvsnCd() != null
						...
						castOther.getElsEvntDvsnCd()))) && (this.getElsEvntSeq() == castOther.getElsEvntSeq());
	}
