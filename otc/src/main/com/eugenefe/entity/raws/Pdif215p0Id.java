...
/**
 * Pdif215p0Id generated by hbm2java
 */
@Embeddable
public class Pdif215p0Id implements java.io.Serializable {

	private String pdno;
	private String prdtTypeCd;
	private String elsEvntDvsnCd;
	private long elsEvntSeq;
	private long jumpBarrierRtSeq;

	public Pdif215p0Id() {
	}

	public Pdif215p0Id(String pdno, String prdtTypeCd, String elsEvntDvsnCd, long elsEvntSeq, long jumpBarrierRtSeq) {
		this.pdno = pdno;
		this.prdtTypeCd = prdtTypeCd;
		this.elsEvntDvsnCd = elsEvntDvsnCd;
		this.elsEvntSeq = elsEvntSeq;
		this.jumpBarrierRtSeq = jumpBarrierRtSeq;
	}
	...
	@Column(name = "JUMP_BARRIER_RT_SEQ", nullable = false, precision = 16, scale = 0)
	public long getJumpBarrierRtSeq() {
		return this.jumpBarrierRtSeq;
	}

	public void setJumpBarrierRtSeq(long jumpBarrierRtSeq) {
		this.jumpBarrierRtSeq = jumpBarrierRtSeq;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof Pdif215p0Id))
			return false;
		Pdif215p0Id castOther = (Pdif215p0Id) other;
		...
		return ((this.getPdno() == castOther.getPdno()) || (this.getPdno() != null && castOther.getPdno() != null && this
				...
				&& (this.getJumpBarrierRtSeq() == castOther.getJumpBarrierRtSeq());
	}
	...
	public int hashCode() {
		...
		result = 37 * result + (int) this.getJumpBarrierRtSeq();
		return result;
	}
