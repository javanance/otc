...
public class PositionHisCrud implements java.io.Serializable {
	...
	public PositionHisCrud() {
	}

	public PositionHisCrud(PositionReturnId id) {
		this.id= id;
	}
	public PositionHisCrud(String bssd, String posId) {
	...
	@Column(name = "UNIT_PRICE1", scale = 8)
	...
	@Column(name = "UNIT_PRICE2", scale = 8)
