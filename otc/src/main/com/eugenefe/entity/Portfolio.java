 ...
 */
@Entity
@Table(name = "PORTFOLIO", schema="TAKION99")
...
//	private String portPrefix;
	...
	private List<PropertyEquationNew> portDefineIndexList = new ArrayList<PropertyEquationNew>();
...
//	}
	...
	@ManyToOne
	@JoinColumn(name="HIER_ID", insertable=true, updatable=true)
...
//	@Transient
	...
	@IndexColumn(name="PORT_LEVEL" , base=1)
//	@JoinTable(name="PORTFOLIO_DEFINE")
//	@Cascade({CascadeType.SAVE_UPDATE, CascadeType.DELETE})
	public List<PropertyEquationNew> getPortDefineIndexList() {
		return portDefineIndexList;
	}

	public void setPortDefineIndexList(List<PropertyEquationNew> portDefineIndexList) {
