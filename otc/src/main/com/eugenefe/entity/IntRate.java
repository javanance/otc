...
import com.eugenefe.entity.component.HisDataNew;
...
//	@Transient
	...
	public PriceData getPriceData(String bssd) {
		if(getIntRate().get(bssd)==null){
			return null;
		}
		return new PriceData(bssd, getIntRate().get(bssd).doubleValue());
	}
...
//	@MapKeyColumn(name="BSSD")
//	@AttributeOverrides( {
//			@AttributeOverride(name="basePrice", column=@Column(name="INT_RATE")),
//			@AttributeOverride(name="openPrice", column=@Column(name="INT_RATE")),
//			@AttributeOverride(name="highPrice", column=@Column(name="INT_RATE")),
//			@AttributeOverride(name="lowPrice", column=@Column(name="INT_RATE")),
//			@AttributeOverride(name="volume", column=@Column(name="INT_RATE")),
//			@AttributeOverride(name="volumeAmt", column=@Column(name="INT_RATE")),
//			@AttributeOverride(name="closePrice", column=@Column(name="INT_RATE"))
//	})
