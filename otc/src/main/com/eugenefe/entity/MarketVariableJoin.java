...
public class MarketVariableJoin implements java.io.Serializable , Comparable<MarketVariableJoin>{
...
//	private List<Position> positions = new ArrayList<Position>();
	...
	public MarketVariableJoin() {
	}

	public MarketVariableJoin(String mvId) {
		this.mvId = mvId;
	}
