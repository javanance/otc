...
public class HierNode implements java.io.Serializable {
	...
	public HierNode(String nodeId) {
		this.nodeId = nodeId;
	}

	public HierNode(String nodeId, String nodeName, String nodeGroup, String tableId, String tableName,
