...
public class LazyModelVolatilityHis extends LazyDataModel<VolatilityHis> {

	// @Logger
	// private Log log;

	private List<VolatilityHis> datasource;

	public List<VolatilityHis> getDatasource() {
		return datasource;
	}

	public void setDatasource(List<VolatilityHis> datasource) {
		this.datasource = datasource;
	}

	public LazyModelVolatilityHis(List<VolatilityHis> datasource) {
		this.datasource = datasource;
	}

	@Override
	public VolatilityHis getRowData(String rowKey) {
		for (VolatilityHis aa : datasource) {
			if (aa.getId().getBssd().equals(rowKey))
				return aa;
		}
		return null;
	}
	...
	@Override
	public Object getRowKey(VolatilityHis volHis) {
		return volHis.getId();
	}
