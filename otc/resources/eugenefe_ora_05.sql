...
DROP TABLE TAKION79.PRODUCT_GREEKS;
DROP TABLE TAKION79.PRODUCT_RETURN;
...
DROP TABLE TAKION79.HIERARCHY_DETAIL;
DROP TABLE TAKION79.PORTFOLIO_COMPO;
DROP TABLE TAKION79.PORTFOLIO_NEW;
DROP TABLE TAKION79.HIERARCHY;
DROP TABLE TAKION79.HIER_NODE;
DROP TABLE TAKION79.IRC_BUCKET_DETAIL;
DROP TABLE TAKION79.INT_RATE;
DROP TABLE TAKION79.IRC_FUNCTION_DETAIL;
DROP TABLE TAKION79.PRICING_UNDERLYINGS;
DROP TABLE TAKION79.PRICING_MASTER;
DROP TABLE TAKION79.IR_CURVE;
DROP TABLE TAKION79.MACRO_INDEX;
DROP TABLE TAKION79.OPTIONS;
DROP TABLE TAKION79.QDATA_MAPPING;
...
DROP TABLE TAKION79.PRICING_MAPPING;
DROP TABLE TAKION79.PRICING_DLL;
DROP TABLE TAKION79.MV_TYPE;
DROP TABLE TAKION79.PORTFOLIO_CHILD;
DROP TABLE TAKION79.PORTFOLIO;
DROP TABLE TAKION79.PRICER;
DROP TABLE TAKION79.PRICING_OBJECT;
DROP TABLE TAKION79.QDATA_HIS;
DROP TABLE TAKION79.QDATA_MASTER;
...
CREATE TABLE TAKION79.HIERARCHY
(
	HIERARCHY_ID VARCHAR2(20) NOT NULL,
	HIERARCHY_NAME VARCHAR2(50),
	USE_YN VARCHAR2(1),
	PRIMARY KEY (HIERARCHY_ID)
);


CREATE TABLE TAKION79.HIERARCHY_DETAIL
(
	HIERARCHY_ID VARCHAR2(20) NOT NULL,
...
CREATE TABLE TAKION79.MV_TYPE
(
	MV_TYPE VARCHAR2(20) NOT NULL,
	MV_TYPE_NAME VARCHAR2(50),
	PARENT_MV_TYPE VARCHAR2(20) NOT NULL,
	PRIMARY KEY (MV_TYPE)
);
...
CREATE TABLE TAKION79.PORTFOLIO_COMPO
(
	PORTFOLIO_ID VARCHAR2(20) NOT NULL,
	PARENT_PORTFOLIO_ID VARCHAR2(20) NOT NULL,
	-- 상위  포트폴리오 구성시 
	-- 포트폴리오에 곱해지는 비중
	-- 
	PORT_WEIGHT NUMBER(10,4),
...
CREATE TABLE TAKION79.PORTFOLIO_NEW
(
	PORTFOLIO_ID VARCHAR2(20) NOT NULL,
	PORTFOLIO_NAME VARCHAR2(50),
	-- PORTFOLIO 생성방법에  따른  유형
	-- 계층구조를 이용, 사용자 직접 생성,  노드 추가등
	PORTFOLIO_TYPE VARCHAR2(20),
	HIERARCHY_ID VARCHAR2(20),
	PRIMARY KEY (PORTFOLIO_ID)
);
...
(
	-- ALL
	-- VAR(RM,HS,MC)
	-- BACKOFFICE(DAILY, MONTHLY, FISCAL)
	-- VALIDATION(SOFT, HARD)
	-- NEW_PRODUCT
	PRICING_OBJ_ID VARCHAR2(20) NOT NULL,
	PROD_ID VARCHAR2(20) NOT NULL,
	-- PRICING 모듈 식별자
	PRICER_ID VARCHAR2(20) NOT NULL,
	IRC_ID VARCHAR2(20) NOT NULL,
	VOL_CURVE_ID VARCHAR2(20),
	VCV_ID VARCHAR2(20),
	-- MC 시뮬레이션 회수
	MC_NUM NUMBER(10),
	-- FDM 격자수
	FDM_LATTICE_NUM NUMBER(10),
	PRIMARY KEY (PRICING_OBJ_ID, PROD_ID)
);


CREATE TABLE TAKION79.PRICING_DLL
(
	DLL_ID VARCHAR2(20) NOT NULL,
	DLL_NAME VARCHAR2(50),
	-- MC, FDM, ANALYTIC
	DLL_TYPE VARCHAR2(20),
	DLL_VENDOR VARCHAR2(20),
	COVERED_MV_TYPE VARCHAR2(20) NOT NULL,
	DESCRIPTION VARCHAR2(255),
	PRIMARY KEY (DLL_ID)
);


CREATE TABLE TAKION79.PRICING_MAPPING
(
	-- ALL
	-- VAR(RM,HS,MC)
	-- BACKOFFICE(DAILY, MONTHLY, FISCAL)
	...
	-- ,AS_DEFIEND
	-- ,AS_
	DISCOUNT_SETTING VARCHAR2(20),
	-- MONEY/TIME VOL
	-- ,LOCAL VOL
	-- ,FLAT 
	VOL_TYPE VARCHAR2(20),
	-- AS_DEFINED
	-- ,AS_
	VOL_SETTING VARCHAR2(20),
	SIMULATION_NUM NUMBER(10),
	LATTICE_NUM NUMBER(10),
	PRIMARY KEY (PRICING_OBJ_ID, MV_TYPE)
);


CREATE TABLE TAKION79.PRICING_MASTER
(
	-- ALL
	-- VAR(RM,HS,MC)
	-- BACKOFFICE(DAILY, MONTHLY, FISCAL)
	...
	MV_TYPE VARCHAR2(20) NOT NULL,
	DLL_ID VARCHAR2(20) NOT NULL,
	DISCOUNT_IRC_ID VARCHAR2(20) NOT NULL,
	SIMULATION_NUM NUMBER(10),
	LATTICE_NUM NUMBER(10),
	PRIMARY KEY (PRICING_OBJ_ID, PROD_ID)
);
...
CREATE TABLE TAKION79.PRICING_OBJECT
(
	-- ALL
	-- VAR(RM,HS,MC)
	-- BACKOFFICE(DAILY, MONTHLY, FISCAL)
	...
	-- NEW_PRODUCT
	PRICING_OBJ_ID VARCHAR2(20) NOT NULL,
	PRICNG_OBJ_NAME VARCHAR2(50),
	-- ALL
	-- VAR(RM,HS,MC)
	-- BACKOFFICE(DAILY, MONTHLY, FISCAL)
	-- VALIDATION(SOFT, HARD)
	-- NEW_PRODUCT
	PARENT_PRICING_OBJ_ID VARCHAR2(20) NOT NULL,
	PRIMARY KEY (PRICING_OBJ_ID)
);
...
(
	...
	REF_IRC_ID VARCHAR2(20),
	VOL_CURVE_ID VARCHAR2(20),
	PRIMARY KEY (PRICING_OBJ_ID, PROD_ID, STOCK_ID)
);


CREATE TABLE TAKION79.PRICING_UNDERLYINGS
(
	-- ALL
	-- VAR(RM,HS,MC)
	-- BACKOFFICE(DAILY, MONTHLY, FISCAL)
	...
	PRIMARY KEY (PRICING_OBJ_ID, PROD_ID, UNDERLYING_ID)
);
...
CREATE TABLE TAKION79.PRODUCT_GREEKS
(
	BSSD VARCHAR2(8) NOT NULL,
	-- ALL
	-- VAR(RM,HS,MC)
	...
	GAMMA NUMBER(10,4),
	VEGA NUMBER(10,4),
	PRIMARY KEY (BSSD, PRICING_OBJ_ID, PROD_ID, UNDERLYING_ID)
);


CREATE TABLE TAKION79.PRODUCT_RETURN
(
	BSSD VARCHAR2(8) NOT NULL,
	-- ALL
	-- VAR(RM,HS,MC)
	...
	THETA_RETURN NUMBER(19,4),
	RHO_RETURN NUMBER(19,4),
	PRIMARY KEY (BSSD, PRICING_OBJ_ID, PROD_ID)
);


CREATE TABLE TAKION79.QDATA_HIS
(
	...
	CLOSE_PRICE NUMBER(19,4),
	VOLUME NUMBER(19,4),
	OPNE_INTEREST NUMBER(19,4),
	PRIMARY KEY (BASE_DATE, Q_ID)
);


CREATE TABLE TAKION79.QDATA_MAPPING
(
	MV_ID VARCHAR2(20) NOT NULL,
	Q_ID VARCHAR2(20) NOT NULL UNIQUE,
	PRIMARY KEY (MV_ID)
);


CREATE TABLE TAKION79.QDATA_MASTER
(
	Q_ID VARCHAR2(20) NOT NULL,
	Q_NAME VARCHAR2(50),
	Q_CODE VARCHAR2(50),
	Q_SOURCE VARCHAR2(50),
	Q_TYPE VARCHAR2(20),
	PRIVATE_YN VARCHAR2(1),
	DISPLAY_URL VARCHAR2(50),
	URLIZE_NAME VARCHAR2(100),
...
(
	...
	FACE_AMT NUMBER(10,0),
	-- 기초자산으로 사용 여부
	USE_AS_UNDERLYING_YN CHAR(1) DEFAULT 'N',
	SOURCE_TABLE VARCHAR2(50),
	USER_NAME VARCHAR2(20),
	LAST_UPDATED VARCHAR2(8),
	VERSION_NO NUMBER,
...
COMMENT ON COLUMN TAKION79.PORTFOLIO_COMPO.PORT_WEIGHT IS '상위  포트폴리오 구성시 
포트폴리오에 곱해지는 비중
';
COMMENT ON COLUMN TAKION79.PORTFOLIO_NEW.PORTFOLIO_TYPE IS 'PORTFOLIO 생성방법에  따른  유형
계층구조를 이용, 사용자 직접 생성,  노드 추가등';
...
KIS
NUMERIX';
COMMENT ON COLUMN TAKION79.PRICING.PRICING_OBJ_ID IS 'ALL
VAR(RM,HS,MC)
BACKOFFICE(DAILY, MONTHLY, FISCAL)
VALIDATION(SOFT, HARD)
NEW_PRODUCT';
...
COMMENT ON COLUMN TAKION79.PRICING_DLL.DLL_TYPE IS 'MC, FDM, ANALYTIC';
COMMENT ON COLUMN TAKION79.PRICING_MAPPING.PRICING_OBJ_ID IS 'ALL
VAR(RM,HS,MC)
BACKOFFICE(DAILY, MONTHLY, FISCAL)
VALIDATION(SOFT, HARD)
NEW_PRODUCT';
COMMENT ON COLUMN TAKION79.PRICING_MAPPING.DISCOUNT_SETTING IS 'AS_RATING
,AS_DEFIEND
,AS_';
COMMENT ON COLUMN TAKION79.PRICING_MAPPING.VOL_TYPE IS 'MONEY/TIME VOL
,LOCAL VOL
,FLAT ';
COMMENT ON COLUMN TAKION79.PRICING_MAPPING.VOL_SETTING IS 'AS_DEFINED
,AS_';
COMMENT ON COLUMN TAKION79.PRICING_MASTER.PRICING_OBJ_ID IS 'ALL
VAR(RM,HS,MC)
BACKOFFICE(DAILY, MONTHLY, FISCAL)
VALIDATION(SOFT, HARD)
NEW_PRODUCT';
COMMENT ON COLUMN TAKION79.PRICING_OBJECT.PRICING_OBJ_ID IS 'ALL
VAR(RM,HS,MC)
BACKOFFICE(DAILY, MONTHLY, FISCAL)
VALIDATION(SOFT, HARD)
NEW_PRODUCT';
COMMENT ON COLUMN TAKION79.PRICING_OBJECT.PARENT_PRICING_OBJ_ID IS 'ALL
VAR(RM,HS,MC)
BACKOFFICE(DAILY, MONTHLY, FISCAL)
VALIDATION(SOFT, HARD)
NEW_PRODUCT';
COMMENT ON COLUMN TAKION79.PRICING_UNDERLYING.PRICING_OBJ_ID IS 'ALL
VAR(RM,HS,MC)
BACKOFFICE(DAILY, MONTHLY, FISCAL)
VALIDATION(SOFT, HARD)
NEW_PRODUCT';
COMMENT ON COLUMN TAKION79.PRICING_UNDERLYINGS.PRICING_OBJ_ID IS 'ALL
VAR(RM,HS,MC)
BACKOFFICE(DAILY, MONTHLY, FISCAL)
VALIDATION(SOFT, HARD)
NEW_PRODUCT';
COMMENT ON COLUMN TAKION79.PRODUCT_GREEKS.PRICING_OBJ_ID IS 'ALL
VAR(RM,HS,MC)
BACKOFFICE(DAILY, MONTHLY, FISCAL)
VALIDATION(SOFT, HARD)
NEW_PRODUCT';
COMMENT ON COLUMN TAKION79.PRODUCT_RETURN.PRICING_OBJ_ID IS 'ALL
VAR(RM,HS,MC)
BACKOFFICE(DAILY, MONTHLY, FISCAL)
VALIDATION(SOFT, HARD)
NEW_PRODUCT';
...
COMMENT ON COLUMN TAKION79.STOCK.USE_AS_UNDERLYING_YN IS '기초자산으로 사용 여부';
